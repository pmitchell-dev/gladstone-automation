...
echo "📦 Checking and installing system dependencies (jq, curl, git, bc, zip, cifs-utils, python3, smbclient, rclone)..."
sudo apt update && sudo apt install -y jq curl git bc zip cifs-utils python3 smbclient rclone
